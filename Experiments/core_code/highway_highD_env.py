...
def calculate_ttc(scene, length):
    """
    Calculate the Time to Collision (TTC) for rear-end collision scenarios, supporting batch processing
    
    Parameters:
        scene: 2D numpy array with shape (N, 3), where each row contains [rear vehicle speed, front vehicle speed, distance between vehicles]
    ...
    # Initialize TTC array: set safe scenarios to 999, calculate TTC for dangerous scenarios
